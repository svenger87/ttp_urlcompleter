...
const String prodPlan3w =
    'http://ttp-connect.sip.local/schedule/ZPPLAN_3W.pdf#view=FitH';
...
const String intranet = 'http://ttp-connect.sip.local';
...
const String matplan =
    'http://ttp-connect.sip.local/schedule/ZPPLAN_M.pdf#view=FitH';
